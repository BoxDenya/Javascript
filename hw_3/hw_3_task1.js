...
// function usersReg(date1, date2) {
//     return users.filter(item => item.registrationDate == date1 || item.registrationDate == date2)    
// }

// console.log(usersReg('09.10.2021', '10.10.2021'))
